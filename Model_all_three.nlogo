...
[
  ...
  ; Comment individual morality
  individual_morality ; <----------- NEW (1&2)
...
[
  ...
  ; Comment: the overall morality value
  Parameter_Morality ; <----------- NEW (1&2)

  ; Comment: threshold for killing
  ; threshold ; <----------- NEW (2)

  ; Comment: how morality deviated
  SD_morality ; <----------- NEW (1&2)
...
to setup
  ...
  ; Comment Set global morality parameters
  ...
  [
    ...
    set individual_morality random-normal Parameter_Morality SD_Morality ; <----------- NEW (2)
...
to murder
  ask turtles [
    ...
    if partner != nobody [
      let moral_difference abs (individual_morality - [individual_morality] of partner)
      if moral_difference > threshold [
        if random-float 1 < 0.5 [ ; 50% probability
          ; Increment the number of murders before agents die
    ...
    [
      ...
      [
        ...
        [
          ...
          ; Comment: initialize individual morality
          set individual_morality random-normal Parameter_Morality SD_Morality   ; <----------- NEW (1&2)
          ; comment birth has positive impact on morality
          set Parameter_Morality max (list 0 (Parameter_Morality + 0.05))   ; <----------- NEW (1&2)
          set Parameter_Morality min (list 2 (Parameter_Morality))   ; <----------- NEW (1&2)
...
to checkAccident
  ...
  [
    ...
    [
      ...
      set Parameter_Morality max (list 0 (Parameter_Morality - 0.01))
      set Parameter_Morality min (list 2 (Parameter_Morality))
      ...
      [
        ...
        [
          ...
          set Parameter_Morality max (list 0 (Parameter_Morality - 0.03))
          set Parameter_Morality min (list 2 (Parameter_Morality))
    ...
    [
      ; comment death has negative impact on morality
      set Parameter_Morality max (list 0 (Parameter_Morality - 0.02))
      set Parameter_Morality min (list 2 (Parameter_Morality))
      ...
      [
        ...
        [
          ; comment death has negative impact on morality
          set Parameter_Morality max (list 0 (Parameter_Morality - 0.04))
          set Parameter_Morality min (list 2 (Parameter_Morality))
          ; Kill the affected members:
          ask up-to-n-of kills turtles with [pcolor = 0] [ die ]
    ...
    [
      ...
      [
        ...
        [
          ; comment death has negative impact on morality
          set Parameter_Morality max (list 0 (Parameter_Morality - 0.05))
          set Parameter_Morality min (list 2 (Parameter_Morality))
          ; Kill the affected members:
          ask up-to-n-of kills turtles with [pcolor = 0] [ die ]
    ...
    [
      ...
      [
        ...
        [
          ; comment death has negative impact on morality
          set Parameter_Morality max (list 0 (Parameter_Morality - 0.06))
          set Parameter_Morality min (list 2 (Parameter_Morality))
          ; Kill the affected members:
          ask up-to-n-of kills turtles with [pcolor = 0] [ die ]
